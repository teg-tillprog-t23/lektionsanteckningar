...
class Enemy:
    ...
    def __init__(self, x=10, y=200):
        ...
        self.y = y
        """HÄR ÄR DET NYTT"""
        self.dx = 0 # sätter hur x ska ändras, här har vi bara att fienden pattrullerar i x-led
        self.dy = 0 # sätter hur y ska ändras
        self.size = 20
        self.speed = 3 # avgör hastigheten som fienden rör sig
        self.is_alive = True
    ...
    def die(self): # En metod för det som ska göras när fienden dör. Det kan vara mer än att bara sätta is_alive, tex att den först blinkar
        self.is_alive = False
        self.dx = 0 # så att fienden stannar om den har dödat spelaren
        self.dy = 0
